...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，this is Fi, Welcome to my blog!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '编程学习中...', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://errorfounddo.cc', // 网站地址
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-solarizedlight.css', // 代码块默认主题
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '一个编程爱好者的博客', // 站点描述，被notion中的页面描述覆盖
